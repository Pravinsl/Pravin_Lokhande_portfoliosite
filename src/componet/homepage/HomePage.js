...
import { faGoogle, faMicrosoft, faAmazon, faAdobe } from '@fortawesome/free-brands-svg-icons';
import { FaFacebookF, FaWhatsapp, FaLinkedin, FaGithub, FaEnvelope } from 'react-icons/fa';
        ...
        <div className={styles.pageContainer}>
            ...
            <div className={styles.servicesSection}>
                <div className={styles.servicesHeader}>
                    ...
                    <h2 className={styles.servicesTitle}>What Service We Offer For You</h2>
                </div>
